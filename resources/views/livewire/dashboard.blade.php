...
<div class="flex flex-col z-10 my-auto">
    <div class="flex gap-16 justify-between">
        <div class="bg-[#be2929] w-1/2 p-8 rounded-3xl shadow-md shadow-gray-400 text-white">
            <a href="/stok-darah">
                <div class="flex">
        ...
        <div class="bg-white w-1/2 p-10 rounded-3xl drop-shadow-xl shadom-md text-[#be2929]">
        ...
        <div class="bg-[#be2929] w-1/2 p-8 rounded-3xl shadow-md shadow-gray-400 text-white" href="">
            <a href="/poin">
                ...
                <div class="flex ml-3 drop-shadow-lg mt-3 font-bold">
                    ...
                    <p class="pl-6 border-l-2 font-sm"><span id="reward_points" class="text-3xl"></span> <br />Poin
                        Reward
                    </p>
                </div>
            </a>
